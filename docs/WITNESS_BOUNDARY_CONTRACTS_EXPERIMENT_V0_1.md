# WITNESS Boundary Contracts — Preregistered Experiment Specification v0.1

**Status:** Frozen preregistration draft  
**Date frozen:** 2026-08-02  
**Target repository:** `CULPRITCHAOS/MCP-Sentinel`  
**Proposed branch:** `experiment/witness-boundary-contracts-v0`  
...
Concrete contracts are provided in `boundary-contracts-v0.1.yaml`.
...
```text
docs/
  WITNESS_BOUNDARY_CONTRACTS_EXPERIMENT_V0_1.md
  WITNESS_CLAIMS_MATRIX_V0_1.md

contracts/
  boundary-contracts-v0.1.yaml
...
## 16. Definition of Done for experiment v0.1
...
The purpose of v0.1 is not to prove WITNESS is important.
